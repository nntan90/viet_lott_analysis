"""
src/crawlers/lottery635_crawler.py
Crawler for Vietlott Lottery 6/35.
Numbers: 6 from 1–35. Schedule: TBD (placeholder cron).
"""
...
log = get_logger("crawler.lottery635")


class Lottery635Crawler(BaseCrawler):
    """Scrape 6/35 results from vietlott.vn."""

    API_URL = "https://vietlott.vn/vi/trung-thuong/ket-qua-trung-thuong/128"

    def __init__(self, **kwargs):
        super().__init__(lottery_type="lottery_635", **kwargs)
